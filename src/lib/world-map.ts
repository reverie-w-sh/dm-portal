...
export const WORLD_LOCATIONS: WorldLocation[] = [
  ...
  { id: "blood", slug: "blood-dungeon", name: "Кровавое подземелье", shortName: "Дом Боли", description: "Кровавое подземелье, в прошлом известное как Дом Боли.", image: "/images/world/locations/blood-dungeon.jpg", guideHref: "/dom-boli", guideLabel: "Открыть карты Дома Боли", mapPoint: { x: 45, y: 23 } },
  ...
  { id: "towers", slug: "siege-tower", name: "Башня Познания", shortName: "Башня", description: "Сюда нести дуб! Башня сообщества. Увеличивает опыт.", image: "/images/world/locations/towers.jpg", mapPoint: { x: 95, y: 67 } },
  ...
  { id: "guardian", slug: "guardian", name: "Хранитель", description: "Комната Хранителя в Серой Пещере. Квесты.", image: "/images/world/locations/guardian.jpg", mapPoint: { x: 84, y: 9 } },
  { id: "labyrinth", slug: "labyrinth", name: "Лабиринт", description: "Это лабиринт. Там стены, проходы, пазлы, мобы, сундуки, все такое", image: "/images/world/locations/labyrinth.jpg", mapPoint: { x: 72, y: 6 } },
...
const WORLD_EDGES: WorldEdge[] = [
  ...
  { from: "lake-road", to: "lake-road-fishing", forward: "На Дороге к озеру нажми «Дорога к озеру».", backward: "На второй Дороге к озеру нажми стрелку вправо." },
  { from: "lake-road-fishing", to: "fisher-road", forward: "На второй Дороге к озеру нажми «Путь рыбака».", backward: "С Пути рыбака вернись на Дорогу к озеру." },
  { from: "lake-road-fishing", to: "fish-shop", forward: "На второй Дороге к озеру нажми «Рыбная лавка».", backward: "Выйди из Рыбной лавки на Дорогу к озеру." },
  { from: "lake-road-fishing", to: "lake", forward: "На второй Дороге к озеру нажми «Озеро».", backward: "На Озере нажми стрелку вправо." },
