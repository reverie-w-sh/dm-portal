...
export const WORLD_LOCATIONS: WorldLocation[] = [
  ...
  { id: "shop", slug: "shop", name: "Лавка", description: "Городская лавка на Центральной площади.", image: "/images/world/locations/shop.jpg" },
  { id: "alchemist", slug: "alchemist", name: "Алхимик", description: "Алхимическая лавка на Центральной площади.", image: "/images/world/locations/alchemist.jpg" },
  { id: "market", slug: "market", name: "Рынок", description: "Городской рынок и торговые разделы.", image: "/images/world/locations/market.jpg" },
  { id: "royal-shop", slug: "royal-shop", name: "Королевская лавка", description: "Королевская лавка на Центральной площади.", image: "/images/world/locations/royal-shop.jpg" },
  ...
  { id: "donor", slug: "donor-search", name: "Поиск донора", description: "Сервис поиска донора на Площади шахтёров.", image: "/images/world/locations/donor-search.jpg" },
  { id: "farm", slug: "farm", name: "Ферма", description: "Ферма возле Площади шахтёров." },
  ...
  { id: "vampire-tomb", slug: "vampire-tomb", name: "Гробница вампиров", description: "Тёмная локация возле Площади шахтёров." },
  ...
  { id: "memory-tree", slug: "memory-tree", name: "Дерево памяти", description: "Древнее дерево возле дороги к озеру.", image: "/images/world/locations/memory-tree.jpg", mapPoint: { x: 24, y: 43 } },
  { id: "fisher-road", slug: "fisher-road", name: "Путь рыбака", description: "Лесная дорога, ведущая к озеру.", image: "/images/world/locations/fisher-road.jpg" },
  { id: "fish-shop", slug: "fish-shop", name: "Рыбная лавка", description: "Рыбная лавка на пути к озеру." },
  ...
  { id: "hunting", slug: "hunting-grounds", name: "Охотничьи угодья", description: "Место охоты и охотничьих заданий.", image: "/images/world/locations/hunting-grounds.jpg", guideHref: "/hunter-guide", guideLabel: "Открыть гайд по охоте", mapPoint: { x: 43, y: 73 } },
  ...
  { id: "city-hall", slug: "city-hall", name: "Мэрия", description: "Городская мэрия на Улице гладиаторов.", image: "/images/world/locations/city-hall.jpg" },
  { id: "tavern", slug: "tavern", name: "Трактир", description: "Трактир на Улице гладиаторов.", image: "/images/world/locations/tavern.jpg" },
  { id: "colosseum", slug: "colosseum", name: "Колизей", description: "Боевой район Улицы гладиаторов. Здесь находятся Арена, Бестиарий и Бои сообществ.", image: "/images/world/locations/colosseum.jpg", mapPoint: { x: 91, y: 43 } },
  { id: "arena", slug: "arena", name: "Арена гладиаторов", description: "Арена для гладиаторских боёв.", image: "/images/world/locations/arena.jpg" },
  { id: "bestiary", slug: "bestiary", name: "Бестиарий", description: "Коллекция и бои с монстрами.", image: "/images/world/locations/bestiary.jpg" },
  { id: "community-battles", slug: "community-battles", name: "Бои сообществ", description: "Раздел боёв сообществ в Колизее.", image: "/images/world/locations/community-battles.jpg" },
  ...
  { id: "towers", slug: "siege-towers", name: "Башни", description: "Башни осадного района.", image: "/images/world/locations/towers.jpg" },
  { id: "workshop", slug: "workshop", name: "Мастерская", description: "Ремонт, гравировка, крафт и кожевничество.", image: "/images/world/locations/workshop.jpg" },

  { id: "cave-road", slug: "cave-road", name: "Дорога к Пещерам", description: "Осенняя дорога от Осад к пещерной области.", image: "/images/world/locations/cave-road.jpg", mapPoint: { x: 82, y: 28 } },
  ...
  { id: "guardian", slug: "guardian", name: "Хранитель", description: "Комната Хранителя в Серой Пещере.", image: "/images/world/locations/guardian.jpg" },
  { id: "labyrinth", slug: "labyrinth", name: "Лабиринт", description: "Вход в Лабиринт через комнату Хранителя.", image: "/images/world/locations/labyrinth.jpg" },
  { id: "underground-lake", slug: "underground-lake", name: "Подземное озеро", description: "Подземное озеро в Серой Пещере.", image: "/images/world/locations/underground-lake.jpg" },
  ...
  { id: "malachite", slug: "malachite-mines", name: "Малахитовые Рудники", description: "Подземелье Малахитовые Рудники.", guideHref: "/malahitovye-rudniki", guideLabel: "Открыть карту Рудников" },
  { id: "garden", slug: "garden-of-nightmares", name: "Сад Кошмаров", description: "Подземелье Сад Кошмаров.", guideHref: "/sad-koshmarov", guideLabel: "Открыть карту Сада" },
  { id: "shadow-forest", slug: "shadow-forest", name: "Лес Теней", description: "Подземелье Лес Теней.", guideHref: "/les-teney", guideLabel: "Открыть карту Леса Теней" },
];
...
const WORLD_EDGES: WorldEdge[] = [
  ...
  { from: "lake-road", to: "memory-tree", forward: "На Дороге к озеру нажми «Дерево памяти».", backward: "От Дерева памяти вернись на Дорогу к озеру." },
  ...
  { from: "lake-road", to: "desert", forward: "На Дороге к озеру нажми стрелку влево — в Пустыню.", backward: "В Пустыне нажми стрелку вправо — на Дорогу к озеру." },
  ...
  { from: "sieges", to: "towers", forward: "В разделе Осад открой «Башни».", backward: "Из Башен вернись в Осады." },
  ...
  { from: "grey-cave", to: "guardian", forward: "В Серой Пещере выбери «Хранитель».", backward: "От Хранителя вернись в Серую Пещеру." },
  { from: "guardian", to: "labyrinth", forward: "У Хранителя нажми «Лабиринт».", backward: "В Лабиринте нажми «Вернуться» — к Хранителю." },
  ...
  { from: "grey-cave", to: "rift", forward: "В Серой Пещере выбери «Расщелина».", backward: "Из Расщелины вернись в Серую Пещеру." },
