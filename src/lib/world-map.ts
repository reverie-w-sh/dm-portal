...
export const WORLD_LOCATIONS: WorldLocation[] = [
  ...
  { id: "bestiary", slug: "bestiary", name: "Бестиарий", description: "Бои с монстрами. Скучно, но что поделать... Мы ходим сюда ради опыта и дропа.", image: "/images/world/locations/bestiary.webp", mapPoint: { x: 91, y: 39 } },
