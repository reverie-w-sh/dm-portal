...
export const WORLD_LOCATIONS: WorldLocation[] = [
  ...
  { id: "fisher-road", slug: "fisher-road", name: "Дорога к озеру — к рыбалке", shortName: "Дорога к озеру", description: "Вторая часть Дороги к озеру. Отсюда можно пройти к самому Озеру, в Рыбную лавку или на Путь рыбака.", image: "/images/world/locations/fisher-road.jpg", mapPoint: { x: 22, y: 59 } },
...
const WORLD_EDGES: WorldEdge[] = [
  ...
  { from: "lake-road", to: "fisher-road", forward: "На Дороге к озеру нажми «Дорога к озеру».", backward: "На второй Дороге к озеру нажми стрелку вправо." },
  { from: "fisher-road", to: "fish-shop", forward: "На второй Дороге к озеру нажми «Рыбная лавка».", backward: "Выйди из Рыбной лавки на Дорогу к озеру." },
  { from: "fisher-road", to: "lake", forward: "На второй Дороге к озеру нажми «Озеро».", backward: "На Озере нажми стрелку вправо." },
