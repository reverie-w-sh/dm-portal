      ...
      <article className={styles.shell}>
        ...
        {location.id === "labyrinth" && (
          <section className={styles.locationGuide}>
            ...
            <p>
              Новый поход в Лабиринт становится доступен каждый день в 00:00 по времени сервера. Лабиринты бывают одиночными и групповыми. Для группового необходима компания из 4х персонажей одного уровня. Вероятность того, что соберется 4 новичка в групповой лаб - отрицательная, поэтому нет смысла расписывать что там делать - спрашивай у сокомандников, они все объяснят. 
            </p>

            <h3>Что нужно сделать, если ты пошел в лабиринт в одиночку?</h3>
            <ol className={styles.simpleSteps}>
              ...
              <li><span>1</span><p>Если ты уже вполне уверенно стоишь на ногах: Ходишь по коридорам, сражаешься с мобами и собираешь части пазла.</p></li>
