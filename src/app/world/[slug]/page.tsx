      ...
      <article className={styles.shell}>
        ...
        {location.id === "memory-tree" && (
          <section className={styles.locationGuide}>
            ...
            <ul>
              <li>Чтобы разместить яблоко, нажмите на любую свободную область дерева.</li>
              <li>Чтобы удобрить яблоко, найдите его на дереве. Оно отмечено жёлтым кругом. Нажмите на яблоко, а затем на кнопку «Удобрить +24 часа…».</li>
              <li>За каждое удобрение взимается 1000 серебра.</li>
              <li>Можно пропустить до трёх дней. За каждый пропущенный день необходимо заплатить 1000 серебра.</li>
        ...
        {location.id === "desert" && (
          <section className={styles.locationGuide}>
            ...
            <h2>Пустынь тут много. Очень много</h2>
            <p>
              Пустыня на самом деле не одна. Сначала попадаем в первую, название которой я пока так и не выяснила, а дальше начинается настоящее путешествие по пескам.
            </p>
            ...
            <ul>
              ...
              <li>Между пустынями можно двигаться только в одну сторону, переходя из одной в следующую.</li>
              <li>Стрелка вправо не ведёт в следующую пустыню. Она полностью выводит из локации на Дорогу к озеру. Не промахнитесь, а то песчаное путешествие закончится раньше, чем хотелось 😅</li>
            </ul>
            ...
            <p className={styles.reward}>
              <strong>Для чего нужен корм:</strong> для крафта Посоха собирателя нужны 30 пива и 1000 корма. Посох сокращает время переходов в лесу. Корм также нужен для крафта Рогов гладиатора, которые позволяют убивать на 10-20 мобов больше установленного лимита.
            </p>

            <h3>Что происходит на Пасху</h3>
            <p>
              Во время пасхального события вместо коробок в Пустыне появляются корзинки с крашенками. Ими можно играть с зайкой в таверне в «Камень, ножницы, бумагу» и выигрывать классные призы. А если очень повезёт, можно получить золотое яйцо 🥚✨
            </p>
        ...
        {location.id === "lake" && (
          <section className={styles.locationGuide}>
            ...
            <p>
              Рыбачить на обычном Озере можно один раз в 30 минут. Сама рыбалка длится до 10 минут, но просто смотреть на поплавок всё это время не получится. Нужно дождаться момента, когда надпись «Подсечь» на кнопке станет жёлтой, и вовремя нажать на кнопку.
            </p>
            <p>
              Если включены системные оповещения, игра ещё и подаст звуковой сигнал. Очень полезно, если вы, как и я, успели отвлечься на что-нибудь важное. Например, на кофе ☕
            </p>
            ...
            <div className={styles.itemList}>
              ...
              <article>
                <h4>Удочка (up2)</h4>
                <p><strong>Минимальный уровень: 10.</strong> Ловит рыбу на три крючка. Крафтится примерно из миллиона разных рыб. Ну ладно, не из миллиона, но когда собираешь, кажется именно так 😅</p>
              </article>
        ...
        {location.id === "forest" && (
          <section className={styles.locationGuide}>
            ...
            <p>
              На весь поход по лесу даётся 15 минут. В начале передо мной появляются три дороги: левая тропа, тропа прямо и правая тропа. Можно выбирать любую, неправильной дороги здесь нет.
            </p>
            <ol className={styles.simpleSteps}>
              <li><span>1</span><p>Выбираю любую из трёх троп и иду по ней.</p></li>
              <li><span>2</span><p>Дохожу до поляны и нажимаю «Собирать».</p></li>
              <li><span>3</span><p>После сбора снова выбираю одну из трёх дорог.</p></li>
              <li><span>4</span><p>Повторяю всё, пока не пройду лес или не закончатся 15 минут.</p></li>
            </ol>
            <p className={styles.reward}>
              За один поход встречаются четыре поляны. На каждой не забываем нажимать «Собирать», иначе зачем мы вообще столько бродили по лесу 😅
            </p>
            <p>
        ...
        {location.id === "shop" && (
          <section className={styles.locationGuide}>
            ...
            <p>
              В Лавке можно купить обычную экипировку, не МД, свою самую первую удочку, короб для сбора трав и подарки, которые отображаются в информации о персонаже.
            </p>
            <p>
              Здесь же можно продать ненужные вещи, ресурсы и дроп. Чаще всего Лавка заплатит примерно половину их стоимости, поэтому сначала лучше проверить цены на Рынке. Быстро продать всё одной кнопкой удобно, но наблюдать за полученной суммой иногда немножко больно 😅
            </p>
            <p className={styles.reward}>
              <strong>Мой совет:</strong> если вещь может понадобиться другим игрокам, выгоднее выставить её на Рынке. Лавка подходит, когда хочется освободить рюкзак прямо сейчас и не ждать покупателя.
            </p>
          </section>
        )}
          ...
          <section className={styles.locationGuide}>
            ...
            <div className={styles.licenseGrid}>
              ...
              <article>
                ...
                <p>
                  Даёт все возможности Лицензии торговца и позволяет открыть собственную лавку. Другие игроки смогут покупать ваши вещи, даже когда вы офлайн. Вот это уже торговля без отрыва от сна 😴
                </p>
              </article>
            </div>
        ...
        {location.id === "royal-shop" && (
          <section className={styles.locationGuide}>
            ...
            <ul>
              <li>Купить за реальные деньги через ссылку «Купить терра-голд» в верхней части игры.</li>
        ...
        {location.id === "city-hall" && (
          <section className={styles.locationGuide}>
            <p className={styles.eyebrow}>Хранилища, возрождение и любовь</p>
            ...
            <div className={styles.itemList}>
              ...
              <article>
                <h4>Бракосочетания 💍</h4>
                <p>Во вкладке «Бракосочетания»... Ну, тут и так понятно, что происходит 😄</p>
              </article>
            </div>
            <Link href="/couples" className={styles.guideButton}>
              Посмотреть семейные пары
            </Link>
          </section>
        )}
        ...
        {location.id === "underground-lake" && (
          <section className={styles.locationGuide}>
            ...
            <p>
              Перо выпадает из мобов вашего уровня, но сначала нужно взять квест на его добычу.
            </p>

            <h3>Как проходит рыбалка</h3>
            <p>
              Принцип почти такой же, как на обычном Озере. Закидываем удочку, ждём, пока надпись «Подсечь» станет жёлтой, и нажимаем на кнопку. Рыбалка длится до пяти минут.
            </p>
            <p>
              Но есть одна особенность. Если вместо рыбы вытянули мусор, например водоросли, лягушку, рака или очередной дырявый сапог, можно закинуть удочку ещё раз. Так продолжается, пока наконец не поймается рыбка. Озеро без улова не отпустит, но сначала может хорошенько поиздеваться 😅
            </p>

            <h3>Золотая рыбка</h3>
            <p>
              Один раз в день в Подземном озере можно взять квест на Золотую рыбку. Если она поймается, в награду получаем опыт. Желания она, к сожалению, не исполняет, зато опыт вполне настоящий 🐟✨
            </p>
        ...
        {location.id === "labyrinth" && (
          <section className={styles.locationGuide}>
            ...
            <p>
              Новый поход в Лабиринт становится доступен каждый день в 00:00 по времени сервера. Лабиринты бывают одиночными и групповыми, поэтому перед входом нужно выбрать подходящий тип.
            </p>

            <h3>Что нужно сделать</h3>
            <ol className={styles.simpleSteps}>
              <li><span>1</span><p>Ходим по коридорам, сражаемся с мобами и собираем части пазла.</p></li>
              <li><span>2</span><p>Собираем пазл полностью и получаем два ключа.</p></li>
              <li><span>3</span><p>Находим и открываем этими ключами два сундука.</p></li>
              <li><span>4</span><p>Убиваем Повелителя Лабиринта и получаем третий ключ.</p></li>
              <li><span>5</span><p>Третьим ключом открываем последний сундук и надеемся, что Лабиринт сегодня в хорошем настроении 😅</p></li>
            </ol>

            <h3>Что может попасться в сундуках</h3>
            <p>
              В сундуках можно найти Сердца Лабиринта, зелья или пустые бутылки. А ещё там могут прятаться Духи Лабиринта, которые выпьют всю жизнь, всю ману или сразу и то и другое. Тут уж как повезёт: открываешь сундук с надеждой на сокровище, а остаёшься без всего 🫣
            </p>
