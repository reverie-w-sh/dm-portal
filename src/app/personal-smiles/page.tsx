                        ...
                        <div className="flex flex-wrap items-center gap-x-4 gap-y-2 mt-2 text-sm text-ink-muted">
                          ...
                          {player.clanName && (
                            <span className="flex items-center gap-2">
                              {clanCrestUrl && (
                                <span className="inline-flex h-[21px] w-[21px] shrink-0 items-center justify-center overflow-hidden rounded-[4px] border border-[#c08a3a]/70 bg-[#f5f9ff]">
                                  ...
                                  <img
                                    ...
                                    width={19}
                                    height={19}
                                    className="block h-[19px] w-[19px] object-contain"
                                  />
                                </span>
                              )}
