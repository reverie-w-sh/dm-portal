          ...
          <aside className="space-y-4">
            ...
            <section className="rounded-2xl border border-slate-200 bg-white/90 p-4 shadow-sm">
              ...
              <p className="mt-2 text-xs text-slate-600">
                Нажмите начальную клетку, затем следующую точку, следующую... и так далее
              </p>
            ...
            <section className="rounded-2xl border border-emerald-200 bg-emerald-50/70 p-4 shadow-sm">
              ...
              <p className="mt-2 text-xs text-slate-600">
                Постройте отдельный путь между любыми двумя проходными
                клетками. Он не соединяется с вашим основным маршрутом.
              </p>
