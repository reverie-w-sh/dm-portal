...
const dungeons = [
  ...
  },
  {
    ...
    description: "Интерактивная карта Малахитового Рудника с поиском координат и своими маршрутами.",
  },
  {
    href: "/les-teney",
    title: "Лес Теней",
    description: "Интерактивная карта Леса Теней с поиском координат, маршрутами и метками.",
  },
];
    ...
    <div className="max-w-[1180px] mx-auto px-6 py-10">
      <div className="mb-10">
        ...
        <p className="text-ink-muted mt-3 max-w-2xl leading-relaxed">
          Выбирай нужное подземелье — внутри карта, координаты и маршруты... а может и нет никаких координат, значит когда-то будут! :) Но ты всегда можешь проложить собственный маршрут ;)
        </p>
