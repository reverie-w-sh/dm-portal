...
const guideSteps = [
  {
    ...
    text: "Обычная охота проходит на отдельной карте 4×4. Твоя фигурка находится в одной из 16 клеток, а звери заранее спрятаны по карте.",
    image: "/images/hunter-guide/ohota-karta.webp",
    alt: "Карта Охотничьих угодий 4 на 4 в игре Древний Мир",
    imageTitle: "Охотничьи угодья — карта обычной охоты",
  },
  {
    n: "02",
    ...
    imageTitle: "Осмотр соседних клеток во время охоты",
  },
  {
    n: "03",
  ...
  },
  {
    ...
    text: "После того как зверь найден на карте, перейди в его клетку. Передвижение занимает время, поэтому удобно сначала открывать самые информативные участки карты, а потом собирать уже найденных зверей по ближайшему маршруту.",
...
export default function HunterGuidePage() {
  const jsonLd = {
    ...
    description:
      "Пошаговая инструкция по обычной охоте в Древнем Мире: карта 4×4, осмотр, поиск зверей и подсчёт очков.",
      ...
      <article className="mx-auto max-w-[1090px] rounded-2xl border border-[#79501f] bg-[rgba(4,5,4,.96)] p-4 shadow-[0_20px_55px_rgba(0,0,0,.5),inset_0_0_35px_rgba(0,0,0,.25)] sm:p-7">
        <header>
          ...
          <p className="mt-4 max-w-4xl text-[15px] leading-7 text-[#cbb58d]">
            Если ты впервые открыл Охотничьи угодья и не понимаешь, что означают клетки,
            следы, «Осмотреться» и три кнопки поиска — начинай отсюда. Ниже только обычная
            охота: без фестивалей и дополнительных режимов.
          </p>
        ...
        <section className="mt-8 grid gap-5 lg:grid-cols-[1.12fr_.88fr]">
          <div className="rounded-2xl border border-[#68451d] bg-[#070807] p-5 sm:p-6">
            ...
            <p className="mt-3 text-sm leading-7 text-[#baa787]">
              Поле состоит из 16 клеток. В обычной охоте среди них спрятаны девять зверей.
          ...
          <div className="rounded-2xl border border-[#68451d] bg-[#070807] p-5 sm:p-6">
            ...
            <p className="mt-3 text-sm leading-7 text-[#baa787]">
              В Лесном домике поговори с Дедушкой Егерем. Он проводит через задания,
              связанные с профессией охотника и охотничьим снаряжением. Выполняй его
              реплики по порядку — после подготовки можно переходить к обычной охоте.
            </p>
            <Shot
              src="/images/hunter-guide/ohota-lesnoi-domik.webp"
              alt="Дедушка Егерь в Лесном домике игры Древний Мир"
              title="Лесной домик — начало профессии охотника"
            />
          </div>
        </section>
        ...
        <section className="mt-8 grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-[#68451d] bg-[#070807] p-5">
            ...
            <p className="mt-2 text-sm leading-6 text-[#aa987a]">Одна полученная шкура даёт 3 очка, две — 6.</p>
          </div>
        </section>
