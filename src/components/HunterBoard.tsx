  ...
  return (
    <section className="mx-auto w-full max-w-5xl">
      <div className="mb-5">
        ...
        <p className="mt-2 max-w-3xl text-s leading-relaxed text-slate-300 sm:text-base">
          Даже не пытайся добавить пятого зайца, третьего волка / кабана или второго медведя! А также снять две шкурки с одного зверька! Наш планшет не позволит тебе этого :) 
        </p>
      </div>
